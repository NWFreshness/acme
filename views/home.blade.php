@extends('base')
    ...
    <div class="row">
        <div class="col-md-4 well text-center">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo rem quae deleniti. Provident dignissimos eius, expedita unde. Aperiam perferendis suscipit fuga voluptates obcaecati minus possimus vitae architecto laboriosam assumenda, tempore.</p>
        </div>
        <div class="col-md-4 well empty text-center">
            <h3>Tours</h3>
